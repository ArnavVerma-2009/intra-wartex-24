        ...
        <ol className="relative">
          ...
          <li className="mb-10 ml-4">
            ...
            <p className="text-base font-normal text-gray-300 ">
              The theme is AI. Now, this is a bit hazy ? However, we want you to
              think beyond the box and come up with something you truly would
              preach for. Something you would use, buy, or live if you were in
            ...
            <p className="text-base font-normal text-gray-300 dark:text-gray-300">
              ...
              Development: <br />{" "}
                ...
                {" "}
                  ...
                  {" "}
                  I.Create a website based on the prompt and deploy it on the
                  web.{" "}
                
                <br />
                
                  {" "}
                  II.Only Google typefaces are permitted.{" "}
                
                <br />
                
                  {" "}
                  III.Premade templates are not allowed.{" "}
                ...
                <br />
                  ...
                  {" "}
                  V.You can use standard libraries like Bootstrap and{" "}
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5   "></div>
            <p className="mb-4 text-base font-normal text-gray-300 dark:text-gray-300">
            Submit your entries till 23th October 2023 on Wartexdata@gmail.com for prelims. No entries will be accepted after the said date.
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
            For queries & updates on the event, join our Discord server by clicking on the link below: <Link to=" https://discord.gg/WTpx4uJhSg">https://discord.gg/WTpx4uJhSg</Link> 
