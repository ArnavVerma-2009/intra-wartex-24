...
const Ragnarok = () => {
     ...
     <div className="bg-black">
        ...
        <ol className="relative">
          <li className="mb-10 ml-4">
            ...
            Ragnarok is a 2-day event. The dates will be shared on the Discord Server.<br/>
 Day 1: Round 1 (Online)<br />
 Day 2: Round 2 & 3 (Offline)
          ...
          <li className="mb-10 ml-4">
            ...
            The game for round 1 is Valorant. The details for Round 1 i.e. the game mode and the timings will be shared on the Ragnarok Server itself.  
            </p>
          </li>
          <li className="ml-4 mb-10">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 dark:text-gray-300">
            Rounds 2 & 3 will be held offline in the school premises on 26th October. Details regarding the same will be shared with the qualifiers of Round 1 through Discord only.
Only team-based participation is permitted. No solo players are allowed in the competition.
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5   "></div>
            <p className="mb-4 text-base font-normal text-gray-300 dark:text-gray-300">
            Details regarding Round 2 will be declared on the discord server after Round 1 is finished.
The usage of cheats, hacks, or any other third-party applications that give one an unfair advantage over their opponents will result in immediate disqualification.
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
            Participants must use an acceptable username in the Tournament. If they fail to do it, the administration reserves the right to disqualify them.
            </p>
          </li>
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
...
NOTE: All the participants are requested to join the WARTEX Event discord server for updates:
https://discord.gg/BKE3CH5sMe 
