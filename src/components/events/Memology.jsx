     ...
     <div className="bg-black">
        ...
        <ol className="relative">
          <li className="mb-10 ml-4">
            ...
            Each team can submit a maximum of three memes in video(mp4) or image(jpg/png) format.
          ...
          <li className="mb-10 ml-4">
            ...
            Plagiarism or use of pre-existing meme templates (specially image format) is not allowed.
          ...
          <li className="ml-4 mb-10">
            ...
            <p className="text-base font-normal text-gray-300 dark:text-gray-300">
              ...
              videos/images from the internet with due acknowledgement (sources
              in docs file).
            </p>
          </li>
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5   "></div>
            <p className="mb-4 text-base font-normal text-gray-300 dark:text-gray-300">
            Examples of video memes or short skits can be found at the YouTube channels of Gus Johnson, Sven Johnson, ProZD, Dolan Dark, Grandayy, Man carrying Thing, etc.
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
            The meme should not contain any NSFW elements, and not in any way be overly hurtful/offensive. The meme can be edgy, but the difference between edginess and offensive must be kept in mind.
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
            Any kind of violation of these regulations, will result in disqualification.
          ...
          <li className="mb-10 ml-4">
            ...
            <p className="text-base font-normal text-gray-300 ">
              Judgment Criteria
                ...
                <p className="ml-4">Skills used : 2 Marks</p></ul>
            </p>
          </li>
        </ol>
      </div>
