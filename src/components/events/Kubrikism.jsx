        ...
        <ol className="relative">
          <li className="mb-10 ml-4">
            ...
            <p className="mb-4 text-base font-normal text-gray-300 dark:text-gray-300">
              Write your own script.  You can also ask your family to be the cast for your movie
            </p>
          </li>
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
            Once you've recorded all of your short film clips, combine and edit them.
            </p>
          </li>
          <li className="ml-4 mb-10">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 dark:text-gray-300">
            You may use any software for editing purposes. If any copyrighted material is used, giving credit is compulsory.
            </p>
          </li>
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5   "></div>
            <p className="mb-4 text-base font-normal text-gray-300 dark:text-gray-300">
            Submit your entries till 23th October 2023 on Wartexdata@gmail.com. No entries will be accepted after the said date.
          ...
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
              For queries & updates on the event, join our Discord server by clicking on the link below: https://discord.gg/WTpx4uJhSg
            </p>
          </li>
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
              Judgment Criteria 
                ...
                <p className="ml-4 text-justify">Originality and Creativity :	25 Marks</p>
                <p className="ml-4 text-justify">Video Editing:       	25 Marks</p>
                <p className="ml-4 text-justify">Audio and Video Quality   : 	15 Marks</p>
                <p className="ml-4 text-justify">Script and Acting:    	35 Marks</p>
                </ul>
            </p>
          </li>
