     ...
     <div className="bg-black">
        ...
        <ol className="relative">
          <li className="mb-10 ml-4">
            ...
            A group of 2 participants should work together to make a game on scratch.
            </p>
          </li>
          <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-[#007bc4] rounded-full mt-1.5 -left-1.5  "></div>
            <p className="text-base font-normal text-gray-300 ">
            There is a theme on which the students have to make their game on scratch.
            </p>
          </li>
          ...
          <li className="mb-10 ml-4">
            ...
            <p className="text-base font-normal text-gray-300 ">
              Judgment Criteria
                ...
                <p className="ml-4">Functionality and Engaging Visuals : 10marks </p></ul>
            </p>
          </li>
        </ol>
      </div>
